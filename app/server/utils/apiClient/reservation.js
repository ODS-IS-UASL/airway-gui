export const createReservationApiClient = (event) => {
  const baseURL = useRuntimeConfig().reservationApiBaseUrl;
  const reservationApiKey = useRuntimeConfig().reservationApiKey;
